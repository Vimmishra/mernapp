      ...
      `}
        ...
        >
            ...
            <div onMouseEnter={() => setShowTitle(true)} onMouseLeave={() => setShowTitle(false)} >
                ...
                //we can also pass controls function which is predefined function of react player where we we can see all controls without any problem
                />


                {showTitle && (
                    <div className="absolute top-2 left-2  bg-opacity-70 text-white px-3 py-1 text-2xl">
                        {title}
                    </div>
                )}
